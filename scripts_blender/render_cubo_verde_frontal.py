...
output_dir = r"c:/Users/Admin/Desktop/ZULY_IA_LOCAL/export/pruebas_cubo/frames_animacion_cubo_verde/"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
frame_path = os.path.join(output_dir, "cubo_verde_frontal.png")
bpy.context.scene.render.filepath = frame_path
bpy.ops.render.render(write_still=True)

print("Imagen de cubo verde frontal renderizada y guardada en export/pruebas_cubo/frames_animacion_cubo_verde.")
