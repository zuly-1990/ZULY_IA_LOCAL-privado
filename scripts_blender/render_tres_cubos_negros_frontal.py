...
# Cámara centrada y apuntando al centroide de los cubos
...
# Lente recomendada 50mm
cam.data.lens = 50
# Mostrar límites y nombre de la cámara
...
output_dir = r"c:/Users/Admin/Desktop/ZULY_IA_LOCAL/export/pruebas_cubo/frames_animacion_tres_cubos_negros/"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
frame_path = os.path.join(output_dir, "tres_cubos_negros_frontal.png")
bpy.context.scene.render.filepath = frame_path
bpy.ops.render.render(write_still=True)

# Guardar archivo .blend para revisión manual
bpy.ops.wm.save_as_mainfile(filepath=r"c:/Users/Admin/Desktop/ZULY_IA_LOCAL/export/pruebas_cubo/tres_cubos_negros_frontal.blend")

print("Imagen de tres cubos negros renderizada y guardada en export/pruebas_cubo/frames_animacion_tres_cubos_negros. Archivo .blend guardado para revisión manual.")
