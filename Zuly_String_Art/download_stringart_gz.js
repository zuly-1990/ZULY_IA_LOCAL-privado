...
try {
    const base64Data = execSync('node ../ssh_exec.js "base64 /opt/zuly/StringArt.gz"', { maxBuffer: 50 * 1024 * 1024 });
    ...
    fs.writeFileSync('StringArt.gz', Buffer.from(b64String, 'base64'));
