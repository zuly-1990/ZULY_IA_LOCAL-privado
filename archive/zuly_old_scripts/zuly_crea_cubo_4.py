...
print("\n" + "="*70)
print("🎨 ZULY CREA CUBO_4: 3 Agujeros (X, Y, Z) Coloreados")
print("="*70)
...
try:
    ...
    print("🎯 CUBO_4 LISTO")
    print("="*70)
    print("\n✓ Archivo único: cubo_4.blend (sin duplicados)")
    print("✓ 3 agujeros coloreados (X=rojo, Y=verde, Z=azul)")
