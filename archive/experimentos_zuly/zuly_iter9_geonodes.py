...
BLEND_OUT = '/opt/zuly/Zuly_Villa_Savoye_Nodos_Iter_9.blend'
...
def build_iter_9():
    print("[ZULY] Construyendo Iteración 9 (Corrección Atributo)...")
    ...
    def set_piso_id(mod, val):
        # Desactivamos el uso de atributos (que causaba que ignorara el valor numérico)
        mod["Input_1"] = val
    ...
    print(f"✅ Iteración 9 Completada: {BLEND_OUT}")
