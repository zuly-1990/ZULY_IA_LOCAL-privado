...
BLEND_OUT = '/opt/zuly/Zuly_Villa_Savoye_Nodos_Iter_8.blend'
...
def create_master_tree(mat_ladrillo, mat_marcos, mat_concreto):
    ...
    # En Blender 3.6, la geometría va primero para no tirar error
    ...
    # IMPORTANTE: input_type DEBE SER 'GEOMETRY'. Por defecto es 'FLOAT', lo que hacía la geometría invisible
...
def build_iter_8():
    print("[ZULY] Construyendo Iteración 8 (Corrección Switch Tipo Geometría)...")
    ...
    print(f"✅ Iteración 8 Completada: {BLEND_OUT}")
