...
try {
    const base64Data = execSync('node ssh_exec.js "base64 /opt/zuly/Iter14.gz"', { maxBuffer: 50 * 1024 * 1024 });
    ...
    fs.writeFileSync('Planos y premodelado/Iter14.gz', Buffer.from(b64String, 'base64'));
