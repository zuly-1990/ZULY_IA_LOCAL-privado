...
# -*- coding: utf-8 -*-
"""
🔧 CORREGIDO - ZULY MAESTRO con import math
"""
...
import bpy
import sys
import math  # <-- CORREGIDO: importar math
from pathlib import Path
...
# Cámara aérea - AHORA CON MATH IMPORTADO
...
script_path = zuly_path / 'temp_zuly_maestro_fixed.py'
with open(script_path, 'w', encoding='utf-8') as f:
    f.write(script_maestro)

blender_exe = r"C:\Users\Admin\Desktop\ZULY_IA_LOCAL\blender\v3\blender-3.6.0-zuly\blender.exe"

print("🏆 Generando ZULY_MAESTRO.blend (corregido)...")
...
script_path.unlink()
print("\n✅ ZULY_MAESTRO.blend creado (corregido)")
