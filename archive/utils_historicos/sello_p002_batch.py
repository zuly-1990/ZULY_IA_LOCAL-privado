...
patrones = [
    ("P-002A_EsferaUV_1m", "#E91E63"),
    ("P-002B_EsferaUV_2m", "#673AB7"),
    ("P-002C_EsferaICO_1m", "#00BCD4"),
    ("P-002D_EsferaICO_05m", "#8BC34A"),
    ("P-002E_EsferaUV_05m", "#FFC107"),
]

print("🔧 Sello automático P-002 BATCH (5 esferas)...")
