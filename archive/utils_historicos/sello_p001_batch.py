...
# -*- coding: utf-8 -*-
"""
🔧 SELLO BATCH - P-001 (4 cubos básicos)
"""
...
patrones = [
    ("P-001A_CuboBasico_1m", "#2196F3"),
    ("P-001B_CuboBasico_2m", "#4CAF50"),
    ("P-001C_CuboBasico_05m", "#FF9800"),
    ("P-001D_CuboBasico_3m", "#9C27B0"),
]

print("🔧 Sello automático P-001 BATCH...")
