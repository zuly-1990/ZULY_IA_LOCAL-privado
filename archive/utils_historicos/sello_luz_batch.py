...
# -*- coding: utf-8 -*-
"""
🔧 SELLO BATCH - FASE 3 (2 iluminaciones)
"""
...
patrones = [
    ("LUZ-001_Iluminacion_3Point", "#B0B0B0"),  # Gris neutro
    ("LUZ-002_Iluminacion_HDRI", "#99AACC"),   # Azul cielo
]

print("🔧 Sello automático FASE 3 (2 iluminaciones)...")
...
print("\n✅ FASE 3 sellada (2 iluminaciones)")
