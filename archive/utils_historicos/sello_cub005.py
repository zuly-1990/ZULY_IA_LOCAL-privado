...
# -*- coding: utf-8 -*-
"""
🔧 SELLO AUTOMÁTICO CUB-005 BooleanExacto
"""
...
print("="*70)
print("🔧 SELLO AUTOMÁTICO - CUB-005 BooleanExacto")
print("="*70)

resultado = jues_bot_validar_y_sellar(
    "./archivo_zuly/temp_arena/CUB-005_BooleanExacto.blend",
    "CUB-005_BooleanExacto",
    "#D32F2F",
    aprobar=True
)
...
script_path = zuly_path / 'temp_sello_cub005.py'
with open(script_path, 'w', encoding='utf-8') as f:
    f.write(script_sello)

blender_exe = r"C:\Users\Admin\Desktop\ZULY_IA_LOCAL\blender\v3\blender-3.6.0-zuly\blender.exe"

print("🔧 Sello automático CUB-005...")
